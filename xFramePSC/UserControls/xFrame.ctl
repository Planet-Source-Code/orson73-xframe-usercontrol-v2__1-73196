   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":0312
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":08AC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":0E46
            Key             =   "bluecollapse"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":13E0
            Key             =   "blueexpand"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":197A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":1F14
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":24AE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":2A48
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":2FE2
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":357C
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":3B16
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "xFrame.ctx":40B0
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Attribute VB_Exposed = False
    ...
    Private CollapseOnLeftClick As Boolean
    Private iCollapseCount As Integer
    
    Public bCollapseOnLeftClick As Boolean
    Public bCollapseTopDown As Boolean
    
    Private bExpandHorizontal As Boolean
    Private iOldwidth As Integer
    
    Public bHeaderWasClicked As Boolean
    ...
    Private bMouseOver As Boolean   'deze bepaald expanded
    Private bMouseOverButtonPin As Boolean   'deze bepaald of ie vastgepind wordt of niet
    'OR CODE
    Private bMouseOverImgLeft As Boolean
    Private bVerifyEnabledGradient As Boolean
    Private bButtonOldValue As Boolean
    Private bButtonPinOldValue As Boolean
    
    Private bButtonOldValue2 As Boolean
    Private bButtonPinOldValue2 As Boolean
...
Attribute tmrMouseMove.VB_VarHelpID = -1
    ...
    Event Click()
    Event DblClick()
    Event ClickImgLeft() 'OR Code
    Event ClickHeaderBar()
    ...
    Public Enum BorderrStyle
                    FLAT_SINGLE_COLOR = 0 ' flat single color
                    FLAT_TWO_COLOR = 1 ' flat two color
                    SUNKEN_CUSTOM = 2  ' sunken custom
                    RAISED_CUSTOM = 3 ' raised custom
                    FLAT_SYSTEM_COLOR = 4 ' flat dual using system colors
                    FLAT_CUSTOM_COLOR = 5
                    RAISED_SYSTEM_COLOR = 6 ' raised using system colors
                    SUNKEN_SYSTEM_COLOR = 7
    End Enum
    
    
Public Sub Collapse_On_Left_Click() 'OR CODE
    CollapseOnLeftClick = True
    'set de img
        SetLeftImage ImageList1.ListImages(2 * ColorScheme + 1).Picture
  
    
End Sub
Public Sub SetLeftImage(New_Picture As Picture)
...
Public Sub Resize_xFrames_Up(CollapsFrame As Object, ExpandFrame As Object)

On Error GoTo Error_Hdler_Resize_xFrames

Dim Y_CoOrd_Oud As Integer, Y_CoOrd_Nieuw As Integer, OudeTop As Integer, MarGin_Tussen_Frames As Integer
'
If CollapsFrame.bCollapseTopDown = False Then
          Exit Sub
End If

    MarGin_Tussen_Frames = 100
     'EF moet omhoog schijven
        'oude Y_CoOrd  25 (CF_Top + CF_Height)
             Y_CoOrd_Oud = CollapsFrame.Top + CollapsFrame.Height
            
            CollapsFrame.bCollapseTopDown = True
            
        'nieuwe Y_CoOrd 10 = (CF + CF_Height_Header + MarginTussenFrames)
             OudeTop = ExpandFrame.Top
             ExpandFrame.Top = Y_CoOrd_Oud + MarGin_Tussen_Frames
             
         'nieuwe height
            If ExpandFrame.Height + OudeTop - ExpandFrame.Top > 0 Then
                    ExpandFrame.Height = ExpandFrame.Height + OudeTop - ExpandFrame.Top
                     If CollapsFrame.Height = 315 Then
                                  ExpandFrame.bCollapseTopDown = False
                                  ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) + 9).Picture
                       Else
                                  ExpandFrame.bCollapseTopDown = True
                                   ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) * 2 + 2).Picture
                       End If
...
Error_Hdler_Resize_xFrames:
        If Err.Number = 340 Then
        Else
            MsgBox "Exception: " & Err.Number & " (" & Err.Description & ") at line: " & CStr(Erl) & " in procedure Resize_xFrames_Up of Form frmMain", vbInformation, "Exception in Resize_xFrames"
        End If
End Sub

Public Sub Resize_xFrames_Down(CollapsFrame As Object, ExpandFrame As Object)

On Error GoTo Error_Hdler_Resize_xFrames

Dim X_CoOrd_Oud As Integer, X_CoOrd_Nieuw As Integer, OudeLeft As Integer, MarGin_Tussen_Frames As Integer

If CollapsFrame.bCollapseTopDown = False Then
          Exit Sub
End If

If bHeaderWasClicked = False Then
    Exit Sub
End If

    MarGin_Tussen_Frames = 100
     'EF moet links down schuiven
        'oude X_CoOrd
    
    If bExpanded = False Then
        If CollapsFrame.Top + lUserControlOrigHeight - CollapsFrame.Height > 0 Then
             CollapsFrame.Top = CollapsFrame.Top + lUserControlOrigHeight - CollapsFrame.Height  '- CollapsFrame.Width  ' CollapsFrame.Width
        End If
     Else
'          If CollapsFrame.Height <> 315 Then
''                    If CollapsFrame.Height <> oldheight Then
'                              Exit Sub
''                    End If
'          End If
        If CollapsFrame.Top - CollapsFrame.Height + 315 > 0 Then
             CollapsFrame.Top = CollapsFrame.Top - CollapsFrame.Height + 315 '+ MarGin_Tussen_Frames
        End If
     End If

'         'nieuwe width
            If CollapsFrame.Top - MarGin_Tussen_Frames - ExpandFrame.Top > 0 Then
                              ExpandFrame.Height = CollapsFrame.Top - MarGin_Tussen_Frames - ExpandFrame.Top ' - OudeLeft
                              If CollapsFrame.Height = 315 Then
                                         ExpandFrame.bCollapseTopDown = False
                                         ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) + 9).Picture
                              Else
...
Error_Hdler_Resize_xFrames:
        If Err.Number = 340 Then
        Else
            MsgBox "Exception: " & Err.Number & " (" & Err.Description & ") at line: " & CStr(Erl) & " in procedure Resize_xFrames_Down of Form frmMain", vbInformation, "Exception in Resize_xFrames"
        End If
End Sub

Public Sub Resize_xFrames_Left(CollapsFrame As Object, ExpandFrame As Object)

On Error GoTo Error_Hdler_Resize_xFrames

Dim X_CoOrd_Oud As Integer, X_CoOrd_Nieuw As Integer, OudeLeft As Integer, MarGin_Tussen_Frames As Integer

If CollapsFrame.bCollapseOnLeftClick = False Then
          Exit Sub
End If

    MarGin_Tussen_Frames = 100
     'EF moet links rechts schuiven
        'oude X_CoOrd
             X_CoOrd_Oud = CollapsFrame.Left + CollapsFrame.Width
            
            CollapsFrame.bCollapseOnLeftClick = True
            
        'nieuwe X_CoOrd
             OudeLeft = ExpandFrame.Left
             ExpandFrame.Left = CollapsFrame.Left + CollapsFrame.Width + MarGin_Tussen_Frames
             
         'nieuwe width
            If ExpandFrame.Width + OudeLeft - ExpandFrame.Left > 0 Then
                ExpandFrame.Width = ExpandFrame.Width + OudeLeft - ExpandFrame.Left
                        If CollapsFrame.Width = 300 Then
                                  ExpandFrame.bCollapseOnLeftClick = False
                                  ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) + 9).Picture
                       Else
                                  ExpandFrame.bCollapseOnLeftClick = True
                                   ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) * 2 + 1).Picture
                       End If
            End If
...
Error_Hdler_Resize_xFrames:
        If Err.Number = 340 Then
        Else
            MsgBox "Exception: " & Err.Number & " (" & Err.Description & ") at line: " & CStr(Erl) & " in procedure Resize_xFrames_Left of Form frmMain", vbInformation, "Exception in Resize_xFrames"
        End If
End Sub
Public Sub Refresh()
          UserControl.Refresh
End Sub
Public Sub Resize_xFrames_Right(CollapsFrame As Object, ExpandFrame As Object)
...
End If
    ...
    MarGin_Tussen_Frames = 100
     'EF moet links rechts schuiven
        'oude X_CoOrd
            OudeLeft = CollapsFrame.Left
          CollapsFrame.bCollapseOnLeftClick = True
          
    If bExpandHorizontal = True Then
             'inklappen
             CollapsFrame.Left = CollapsFrame.Left + iOldwidth - CollapsFrame.Width  ' CollapsFrame.Width
     Else
            'uitklappen
             CollapsFrame.Left = CollapsFrame.Left - CollapsFrame.Width + 300 '+ MarGin_Tussen_Frames
     End If

'         'nieuwe width
            If CollapsFrame.Left - MarGin_Tussen_Frames - ExpandFrame.Left > 0 Then
                    ExpandFrame.Width = CollapsFrame.Left - MarGin_Tussen_Frames - ExpandFrame.Left ' - OudeLeft
                        If CollapsFrame.Width = 300 Then
                                      ExpandFrame.bCollapseOnLeftClick = False
                                      ExpandFrame.SetLeftImage ImageList1.ListImages(Int(ExpandFrame.ColorScheme) + 9).Picture
                           Else
...
Error_Hdler_Resize_xFrames:
        If Err.Number = 340 Then
        Else
            MsgBox "Exception: " & Err.Number & " (" & Err.Description & ") at line: " & CStr(Erl) & " in procedure Resize_xFrames_Right of Form frmMain", vbInformation, "Exception in Resize_xFrames"
        End If

End Sub

Public Sub ResizeControlInFrame(xxFrame As Object, innerCtrl As Object, Optional FixWidth As Boolean, Optional FixHeight As Boolean)
On Error Resume Next

    If FixWidth = True Then
    Else
        If xxFrame.Width - innerCtrl.Left - 100 > 0 Then
            innerCtrl.Width = xxFrame.Width - innerCtrl.Left - 100
        End If
    End If
    If FixHeight = True Then
    Else
        If xxFrame.Height - innerCtrl.Top - 100 > 0 Then
            innerCtrl.Height = xxFrame.Height - innerCtrl.Top - 100
        End If
    End If
...
On Error Resume Next
    ...
    For Each UserCtrl In UserControl.ContainedControls
        If new_enabled = True Then
            UserCtrl.Locked = False
        Else
            UserCtrl.Locked = True
        End If
    Next
...
Dim bImgLeftWasClicked As Boolean
    'OR code
    If bMouseOverImgLeft = True Then
            
            bImgLeftWasClicked = True
            If CollapseOnLeftClick = True And bCollapseOnLeftClick = True Then
                        iCollapseCount = iCollapseCount + 1
                            If bExpandHorizontal = True Then
                                                SetLeftImage ImageList1.ListImages(Int(ColorScheme) * 2 + 1).Picture
                                                UserControl.Width = iOldwidth
                                                Button = bButtonOldValue
                                                ButtonPin = bButtonPinOldValue
                                                bExpandHorizontal = False
                                Else
                                                  SetLeftImage ImageList1.ListImages(Int(ColorScheme) * 2 + 2).Picture
                                                  iOldwidth = UserControl.Width
                                                  bButtonOldValue = Button
                                                  bButtonPinOldValue = ButtonPin
                                                  Button = False
                                                  ButtonPin = False
        ...
        Call picHeader_Paint
        RaiseEvent ClickImgLeft
        bMouseOverImgLeft = False
        
'        Exit Sub
    End If
    If bMouseOver = True And bFrameButton = True And bCollapseTopDown = True Then
            RaiseEvent ClickHeaderBar
          
            bHeaderWasClicked = True
                If bPinned = False Then
                    If bImgLeftWasClicked = False Then
    ...
    RaiseEvent Click
End Sub
'Private Sub imgFramePic_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
'    MsgBox "Img is clicked"
'End Sub
Private Sub picHeader_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
     'OR CODE
    If bDisplayPicture = True Then
        If x < (imgFramePic.Width) Then
            bMouseOverImgLeft = True
        Else
            bMouseOverImgLeft = False
        End If
    End If
...
Private Sub UserControl_Initialize()
          bCollapseOnLeftClick = True
          bCollapseTopDown = True
          
          
End Sub
Sub FormatInnerControls(MyBorderStyle As BorderrStyle, Optional RGB_STRING As String, Optional LabelForeColorRGB As String, Optional sControllsToExclude As String)
Dim MyControll As Control
Dim RGBArray() As String, Red As Integer, Green As Integer, Blue As Integer, bSkip As Boolean, i  As Integer
Dim CtrlToExcludeArr() As String, sCtrl As String
          
          If LabelForeColorRGB <> "" Then
                              RGBArray = Split(LabelForeColorRGB, ",")
                              Red = val(RGBArray(0))
                              Green = val(RGBArray(1))
                              Blue = val(RGBArray(2))
          End If

'          If ControllsToExcludeArrayString <> "" Then
'                    CtrlToExcludeArr = Split(ControllsToExcludeArrayString, "|")
'          End If

For Each MyControll In UserControl.ContainedControls
           bSkip = False
           If sControllsToExclude <> "" Then
'                    For i = 0 To UBound(CtrlToExcludeArr) - 1
                              If InStr(LCase(sControllsToExclude), LCase(TypeName(MyControll))) <> 0 Then
                                        bSkip = True
                              End If
'                    Next i
           End If
                    If bSkip = False Then
                               BorderMod.SetCustomBorderControll MyBorderStyle, MyControll, RGB_STRING
                              If LabelForeColorRGB <> "" Then
                                        If TypeName(MyControll) = "Label" Or TypeName(MyControll) = "CheckBox" Or TypeName(MyControll) = "OptionButton" Or TypeName(MyControll) = "Frame" Then
                                                  MyControll.ForeColor = RGB(Red, Green, Blue)
                                        End If
                              End If
                    End If
Next
...
Private Sub UserControl_Resize()
    ...
    If UserControl.Width - 30 > 0 Then
              picHeader.Move 15, 15, UserControl.Width - 30, 300
   Else
              picHeader.Move 15, 15, UserControl.Width, 300
   End If
    picHeader.ZOrder 0
